        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/actors/create') }}" class="btn btn-success btn-sm" title="Add New Actor">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/actors', 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination-wrapper"> {!! $actors->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
